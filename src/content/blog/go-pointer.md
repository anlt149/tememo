...
Tưởng tuọng biến (variable) là một ngôi nhà. Con trỏ chính là địa chỉ của ngôi nhà đó.
...
Dùng con trỏ khi:
- Trạng thái của dữ liệu bắt buộc phải bị thay đổi bởi hàm.
- Cần phân biệt giữa giá trị zero mặc định (ví dụ số 0) và việc "hoàn toàn không có dữ liệu" (nil), đặc biệt hữu dụng khi xử lý JSON null/optional field.
